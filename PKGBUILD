...
pkgdesc='Linux Kernel and modules with the ck1 patchset featuring Brain Fuck Scheduler v0.416, systemtap kernel debug info is enabled, and UTRACE is baked in for userland support.'
